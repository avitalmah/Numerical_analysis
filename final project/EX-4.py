...
def main():
    ...
    a = 0.0
    b = 1.0
    print("\nAccording to the Romberg method, the value of the integral is between 0 and 1")
    romberg(my_f, a, b, 1.0e-12, 4)
    print("\nAccording to the Simpson  method, the value of the integral is between 0 and 1")
